...
function createServer() {
  ...
  app.get('/api/knowledge-packs/:id', (req, res) => {
  ...
  app.put('/api/products/:id/workspace', (req, res) => {
  ...
  app.get('/api/products/:id/pipeline', (req, res) => {
  ...
  app.get('/api/products/:id/artifacts', (req, res) => {
  ...
  app.get('/api/ideas/discover/status', (req, res) => {
